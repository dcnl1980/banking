...
import { LassoSelectIcon, Loader2 } from 'lucide-react'
  ...
  return (
    <section className="auth-form">
        ...
        <Link href="/" className="flex mb-12 cursor-pointer items-center gap-1">
                ...
                alt="Horizon Logo" 
                />
                <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">PayAccept</h1>
                </Link>
...
<div className="flex flex-col gap-1 md:gap-3">
    ...
    <p className="text-16 font-normal text-gray-600">
        {user ? 'Link your bank account to start using PayAccept' : type === 'sign-in' ? 'Sign in to your account' : 'Create an account to start using PayAccept'}
    </p>
</div>
        </header>
        {user ? (
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Button type="submit" disabled={isLoading} className="form-btn">
            ...
            <footer className="flex justify-center gap-1">
                ...
                <Link href={type === 'sign-in' ? '/sign-up' : '/sign-in'} className="text-blue-500 font-semibold cursor-pointer">
